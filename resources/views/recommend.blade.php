<?php
$products1 = DB::table('recommend')
        ->leftJoin('products','recommend.pro_id','products.id')
                                        ...
                                        <div class="col-sm-4">
                                            <div class="product-image-wrapper">
                                                <div class="single-products">
                                                    <div class="productinfo text-center">
                                                        <a href="{{url('/product_details')}}/{{$p->pro_id}}"> 
                                                            <img src="{{url('/')}}/upload/images/medium/{{$p->pro_img}}" alt="" /></a>
                                                        <h2>${{$p->pro_price}}</h2>
                                                        <p>  <a href="{{url('/product_details')}}/{{$p->pro_id}}">{{$p->pro_name}}</a></p>
